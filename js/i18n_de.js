...
'send export': 'Speichern',
'reset export': 'Zurücksetzen',
...
'network:Tabletoperator': 'Tabletbedienung:',
...
'settings:scoring_format': 'Punktsystem',
'settings:scoring_format|3x21': 'BWF (3x21)',
'scorecard:title': 'Spielzettel',
'scorecard:result_title': 'Satzergebnisse',
'scorecard:open': 'Spielzettel öffnen',
'scorecard:winner': 'Satzgewinner',
'scorecard:loser_points': 'Punkte des Verlierers',
'scorecard:cancel': 'Abbrechen',
'scorecard:apply': 'Satz bestätigen',
'scorecard:enter_set': 'Satz eintragen',
'scorecard:leave': 'Spiel verlassen',
'scorecard:stored': 'Ergebnis gespeichert.',
'scorecard:no_sets': 'Noch keine Sätze erfasst',
'scorecard:set_heading': 'Satz {num} eintragen',
'scorecard:finished_set': 'Satz {num}: {score}',
'scorecard:error:loser_points': 'Bitte eine gültige Punktzahl eingeben.',
'scorecard:error:invalid_score': 'Mit dieser Punktzahl kann kein gültiger Satzstand gebildet werden.',
'scorecard:meta:competition': 'Konkurrenz',
'scorecard:meta:round': 'Runde',
'scorecard:meta:date': 'Datum',
'scorecard:meta:time': 'Zeit',
'scorecard:meta:court': 'Feld',
'scorecard:meta:umpire': 'Schiedsrichter',
'scorecard:meta:service_judge': 'Aufschlagrichter',
'scorecard:meta:tabletoperator': 'Tabletbedienung',
'scorecard:meta:called': 'Spielaufruf',
'scorecard:meta:end': 'Spiel Ende',
'kiosk:title': 'Ergebniserfassung',
'kiosk:meta:competition': 'Konkurrenz',
'kiosk:meta:round': 'Runde',
...
'settings:scoring_format|5x11_15~NLA': 'NLA 2019 (5x11 bis max. 15, 120s Pause)',
'settings:scoring_format|5x11/3': 'BWF 2016 Experiment Option 2 (5x11, Verlängerung bis 13)',
'settings:scoring_format|5x11_11': 'UAE (5x11 ohne Verlängerung)',
'settings:scoring_format|3x15_18': 'Verkürzt (3x15 bis max. 18)',
'settings:scoring_format|1x21': 'Bundesliga Goldener Satz (1x21)',
'settings:scoring_format|1x11_15': 'Bundesliga Goldener Satz Experiment (1x11 bis max. 15)',
...
'settings:style:hidden': 'Verborgen (zentrale Verwaltung)',
...
'displaymode:show_court_number': 'Zeige Spielfeldnummer',
'displaymode:show_competition': 'Zeige die Konkurrenz',
'displaymode:show_round': 'Zeige die Runde',
'displaymode:show_players': 'Zeige Spielernamen',
'displaymode:show_team_name': 'Zeige Teamnamen',
'displaymode:show_middle_name': 'Zeige zweiten Vornamen der Spieler',
'displaymode:abbreviate_first_name': 'Vornamen abkürzen',
'displaymode:show_doubles_receiving': 'Unterstreiche den annehmenden Spieler im Doppel',
...
'announcements:round_64': '1. Runde',
'announcements:round_32': '2. Runde',
'announcements:round_16': '3. Runde',
